...
import com.textme.client.gui.GUISceneService;
import com.textme.client.gui.Main;
...
public class LoginController {
    ...
    @FXML
    public void loginUser(ActionEvent actionEvent) throws IOException, ClassNotFoundException {
        if (passCheckBox.isSelected()) {
            passField.setText(textPassField.getText());
        }
